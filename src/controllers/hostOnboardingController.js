...
class HostOnboardingController {
    ...
    async updatePayoutDetails(req, res) {
        try {
            ...
            const userId = req.user.id;
            const { payoutPhoneNumber, payoutPhoneName } = req.body;

            const updatedProfile = await hostOnboardingService.updatePayoutDetails(
                userId, { payoutPhoneNumber, payoutPhoneName }
            );
            ...
            res.json({
                ...
                data: {
                    payoutPhoneNumber: updatedProfile.payoutPhoneNumber,
                    payoutPhoneName: updatedProfile.payoutPhoneName,
