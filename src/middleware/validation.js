...
const validateBooking = [
    ...
    body("paymentMethod")
    .optional()
    .isIn(["MOBILE_MONEY", "ORANGE_MONEY", "CARD", "CASH"])
    .withMessage(
        "Payment method must be MOBILE_MONEY, ORANGE_MONEY, CARD, or CASH"
    ),
    body("phone")
    .optional()
    .matches(/^6[\d]{8}$/)
    .withMessage("Phone number must be in Cameroon format: 6XXXXXXXX"),
    handleValidationErrors,
];
